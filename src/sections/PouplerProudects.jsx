import PouplerProudectsCard from "../components/PouplerProudectsCard"
import { products } from "../constants"

const PouplerProudects = () => {
  return (
    <section id="products"
    className="max-container max-sm:mt-12">
<div className="flex flex-col justify-start gap-5">
  <h2 className="text-4xl font-palanquin font-bold">Our 
  <span className=" text-coral-red"> Poupler </span>Prouducts</h2>
...
{products.map((product) => (
  <PouplerProudectsCard key={product.name} {...product} />
))}
</div>
    </section>
  )
...
export default PouplerProudects